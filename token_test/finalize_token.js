...
var contractAddress = "0xb60ee0010d98f2b34675fcfeef4dc4f7a23c9ce4"
...
eth.sendTransaction({from: web3.eth.accounts[0], to: web3.eth.accounts[1], value: web3.toWei(10, "ether"), gasPrice: "1000"})
miner.start(8); admin.sleepBlocks(1); miner.stop();
eth.sendTransaction({from: web3.eth.accounts[0], to: web3.eth.accounts[2], value: web3.toWei(10, "ether"), gasPrice: "1000"})
eth.sendTransaction({from: web3.eth.accounts[0], to: web3.eth.accounts[3], value: web3.toWei(10, "ether"), gasPrice: "1000"})
miner.start(8); admin.sleepBlocks(5); miner.stop();

myToken.refund.sendTransaction({from: web3.eth.accounts[3], gasPrice: "1000"})

miner.start(8); admin.sleepBlocks(8); miner.stop();
console.log("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
